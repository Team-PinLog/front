...
// 295 추가 수정(요구사항 2.2): xl(≥1280)은 기존 5rem(80px, AppLayout pt-20)을 유지하고, sm·mdlg
// (<1280)는 3.5rem(56px, AppLayout pt-14)을 뺀다 — AppLayout의 헤더 padding 축소와 반드시 함께
// 맞춘다. 페이지 상하 padding도 PAGE_VERTICAL_PADDING_CLASS(xl은 py-6 유지, sm·mdlg는 py-3로 축소)로
// 바뀌었다.
